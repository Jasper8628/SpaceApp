                ...
                <tbody>
                        ...
                        <tr key={hour} className={hour % 2 === 0 ? "even-row" : "odd-row"} >
                            ...
                            <Droppable id={`drop${hour}am`}>
                                ...
                                <td className="schedule-content">
                                    <Draggable id={`${hour}am`}> test </Draggable> Content <span className="far fa-trash-alt"></span>
                                </td>
                    ...
                    {hours.map(hour => (
                        <tr key={hour} className={hour % 2 === 0 ? "even-row" : "odd-row"}>
                            ...
                            <Droppable id={`drop${hour}am`}>
                                <td className="schedule-content">
                                    <Draggable id={`${hour}pm`} >test</Draggable>  Content <span className="far fa-trash-alt"></span>
                                </td>
